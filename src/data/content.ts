...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'Erg Chigaga tours cost a little more because of the 4x4 transfers and remoteness — real value for your privacy. Try the [M\'Hamid–Erg Chigaga 3-day trek](/tours/circuit-3-jours-mhamid-erg-chigaga), or depart directly from [Marrakech](/tours/circuit-4-jours-marrakech-erg-chigaga), [Ouarzazate](/tours/circuit-3-jours-ouarzazate-erg-chigaga), or [Agadir](/tours/circuit-5-jours-agadir-erg-chegaga) on 4- and 5-day desert tours that finish on the Chigaga dunes.',
      },
  ...
  {
    slug: 'how-many-days-morocco-desert-tour',
    title: 'How Many Days Do You Need for a Morocco Desert Tour?',
    excerpt: 'Two, three, four or a week? The right length for a Sahara desert tour depends on where you start and what you want from the dunes. Honest advice with real drive times.',
    content: 'How many days you need for a Morocco desert tour depends on your starting city and the dunes you want to reach. From Marrakech, budget at least three days to sleep on the Erg Chigaga dunes near M\'Hamid; two days works from closer gateways such as Ouarzazate, and a week unlocks the deep desert.',
    author: 'Sahara Vacation Team',
  ...
  {
    slug: 'what-to-pack-sahara-desert-camel-trek',
    title: 'What to Pack for the Sahara Desert: A Camel Trek Packing List That Works',
    excerpt: 'Hot days, cold nights, blowing sand and a camel saddle. Here is the packing list that actually works for a Morocco desert trek — what to wear, what to leave at home.',
    content: 'Packing for the Sahara means dressing for two climates in one day. Light linen layers by day, a real warm layer for the night, closed shoes, a scarf and a small soft bag for the camel. Here is the full packing list.',
    author: 'Sahara Vacation Team',
  ...
  },
  {
    ...
    title: 'Best Time to Visit the Sahara Desert in Morocco (Month by Month)',
    excerpt: 'October to April is the sweet spot, but each month has its own character. Weigh weather, crowds and prices month by month to pick the season that fits your trip.',
    content: 'The best time to visit the Sahara desert in Morocco is October to April. October, November, March and April offer the most comfortable temperatures; winter brings the clearest skies and fewest crowds; summer is only for the heat-tolerant.',
    author: 'Sahara Vacation Team',
