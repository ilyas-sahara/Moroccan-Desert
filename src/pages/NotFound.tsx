      ...
      <section className="relative flex min-h-[80vh] items-center overflow-hidden bg-ink-950 py-24 text-sand-50 lg:py-32">
        ...
        <div className="container-x relative z-10">
          <div className="max-w-2xl">
            <span className="eyebrow text-sand-300"><span className="hairline" /> {t('notFound.eyebrow')}</span>
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              <Link to="/" className="btn-light">
                {t('common.backHome')} <ArrowRight className="h-4 w-4" strokeWidth={1.75} />
              </Link>
              <Link
                to="/tours"
              ...
              >
                <Compass className="h-4 w-4" strokeWidth={1.75} /> {t('common.browseTours')}
              </Link>
            </div>
          </div>
        </div>
